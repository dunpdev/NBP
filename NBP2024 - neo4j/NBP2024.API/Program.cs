...
try
{
    ...
    builder.Services.AddSingleton<AuthorsGraphDbContext>();
    ...
    //builder.Services.AddScoped<IAuthorRepository, AuthorRepository>();  // privremeno zakomentarisati
    builder.Services.AddScoped<IAuthorRepository, AuthorsGraphRepository>();
